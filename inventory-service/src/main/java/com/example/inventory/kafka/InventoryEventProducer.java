...
public class InventoryEventProducer {
    ...
    public void publishInventoryReserved(OrderCreatedEvent orderEvent) {
        InventoryReservedEvent event = InventoryReservedEvent.builder()
                ...
                .totalPrice(orderEvent.getPrice())
                .reservedAt(LocalDateTime.now())
                .build();

        log.info("📤 [Kafka Producer] 재고 확보 성공 이벤트 발행 - orderId: {}, topic: {}",
     ...
     * 재고 확보 실패 이벤트 발행
     */
    public void publishInventoryReservationFailed(Long orderId, String productName,
        ...
        log.info("📤 [Kafka Producer] 재고 확보 실패 이벤트 발행 - orderId: {}, topic: {}",
                event.getOrderId(), TOPIC);
